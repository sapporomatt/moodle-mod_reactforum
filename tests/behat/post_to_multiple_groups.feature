...
Background:
    ...
    And the following "activities" exist:
      ...
      | reactforum      | No group reactforum         | Test reactforum name   | C1     | reactforum        | 0         |          |
      | reactforum      | Separate group reactforum   | Test reactforum name   | C1     | reactforum        | 1         |          |
      | reactforum      | Visible group reactforum    | Test reactforum name   | C1     | reactforum        | 2         |          |
      | reactforum      | Groupings reactforum        | Test reactforum name   | C2     | reactforum        | 1         | G1       |
