...
Feature: Posting to groups in a separate group discussion when restricted to groupings
  In order to post to groups in a reactforum with separate groups and groupings
  As a teacher
  ...
  Background:
    ...
    And I add a "ReactForum" to section "1" and I fill the form with:
      | ReactForum name  | Multiple groups reactforum             |
      | ReactForum type  | Standard reactforum for general use    |
      | Description | Standard reactforum description        |
      | Group mode  | Separate groups                   |
      | Grouping    | G1                                |
    And I add a "ReactForum" to section "1" and I fill the form with:
      | ReactForum name  | Single groups reactforum               |
      | ReactForum type  | Standard reactforum for general use    |
      | Description | Standard reactforum description        |
      | Group mode  | Separate groups                   |
      | Grouping    | G2                                |
  ...
  Scenario: Teacher with accessallgroups can post in all groups
    ...
    And I follow "Course 1"
    And I follow "Multiple groups reactforum"
    ...
    And I follow "Course 1"
    And I follow "Single groups reactforum"
