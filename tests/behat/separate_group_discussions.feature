...
Feature: Posting to all groups in a separate group discussion is restricted to users with access to all groups
  In order to post to all groups in a reactforum with separate groups
  As a teacher
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | reactforum      | Standard reactforum name    | Standard reactforum description    | C1     | sepgroups    | 1         |

  Scenario: Teacher with accessallgroups can view all groups
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I follow "Standard reactforum name"
  ...
  Scenario: Students can view all participants discussions in separate groups mode
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add a new discussion to "Standard reactforum name" reactforum with:
      | Subject | ReactForum post to all participants |
    ...
    And I am on "Course 1" course homepage
    And I follow "Standard reactforum name"
    Then I should see "ReactForum post to all participants"
