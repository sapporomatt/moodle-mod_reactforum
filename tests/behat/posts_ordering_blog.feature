...
Feature: Blog posts are always displayed in reverse chronological order
  In order to use reactforum as a blog
  As a user
  ...
  Background:
    ...
    And I add a "ReactForum" to section "1" and I fill the form with:
      | ReactForum name  | Course blog reactforum                               |
      | Description | Single discussion reactforum description             |
      | ReactForum type  | Standard reactforum displayed in a blog-like format  |
    And I log out
  ...
  Scenario: Replying to a blog post or editing it does not affect its display order
    ...
    #
    When I add a new topic to "Course blog reactforum" reactforum with:
      | Subject | Blog post 1             |
      | Message | This is the first post  |
    And I add a new topic to "Course blog reactforum" reactforum with:
      | Subject | Blog post 2             |
