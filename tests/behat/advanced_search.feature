@mod @mod_reactforum
Feature: The reactforum search allows users to perform advanced searches for reactforum posts
  In order to perform an advanced search for a reactforum post
  As a teacher
  ...
  Background:
    ...
    And I add a new topic to "Announcements" reactforum with:
      | Subject | My subject |
      | Message | My message |
    And I follow "Course 1"
    And I add a new topic to "Announcements" reactforum with:
  ...
  Scenario: Perform an advanced search using any term
    ...
    And I press "Search reactforums"
    And I should see "Advanced search"
    And I set the field "words" to "subject"
    When I press "Search reactforums"
