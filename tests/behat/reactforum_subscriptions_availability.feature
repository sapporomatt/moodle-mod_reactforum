...
Feature: As a teacher I need to see an accurate list of subscribed users
  In order to see who is subscribed to a reactforum
  As a teacher
  ...
  Scenario: A forced reactforum does not allow to edit the subscribers
    When I add a "ReactForum" to section "1" and I fill the form with:
      | ReactForum name        | Forced ReactForum 2 |
      | ReactForum type        | Standard reactforum for general use |
      | Description       | Test reactforum description |
      | Subscription mode | Forced subscription |
      | Availability      | Show on course page |
    And I follow "Forced ReactForum 2"
    And I navigate to "Show/edit current subscribers" in current page administration
  ...
  @javascript
  Scenario: An automatic reactforum lists all subscribers
    When I add a "ReactForum" to section "1" and I fill the form with:
      | ReactForum name        | Forced ReactForum 1 |
      | ReactForum type        | Standard reactforum for general use |
      | Description       | Test reactforum description |
