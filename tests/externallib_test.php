...
class mod_reactforum_external_testcase extends externallib_advanced_testcase {
    ...
    protected function setUp() {
        ...
        require_once($CFG->dirroot . '/mod/reactforum/externallib.php');
    }
    ...
    /**
     * Test get reactforums
     */
    public function test_mod_reactforum_get_reactforums_by_courses() {
        global $USER, $CFG, $DB;
        ...
        $this->assertEquals(2, $DB->count_records_select('reactforum', 'id = :reactforum1 OR id = :reactforum2',
                array('reactforum1' => $reactforum1->id, 'reactforum2' => $reactforum2->id)));
        ...
        // Assign capabilities to view reactforums for reactforum 2.
        $cm2 = get_coursemodule_from_id('reactforum', $reactforum2->cmid, 0, false, MUST_EXIST);
        $context2 = context_module::instance($cm2->id);
        $newrole = create_role('Role 2', 'role2', 'Role 2 description');
        $roleid2 = $this->assignUserCapability('mod/reactforum:viewdiscussion', $context2->id, $newrole);

        // Create what we expect to be returned when querying the two courses.
        unset($reactforum1->displaywordcount);
        unset($reactforum2->displaywordcount);

        $expectedreactforums = array();
        $expectedreactforums[$reactforum1->id] = (array) $reactforum1;
        $expectedreactforums[$reactforum2->id] = (array) $reactforum2;

        // Call the external function passing course ids.
        $reactforums = mod_reactforum_external::get_reactforums_by_courses(array($course1->id, $course2->id));
        $reactforums = external_api::clean_returnvalue(mod_reactforum_external::get_reactforums_by_courses_returns(), $reactforums);
        $this->assertCount(2, $reactforums);
        foreach ($reactforums as $reactforum) {
            $this->assertEquals($expectedreactforums[$reactforum['id']], $reactforum);
        }

        // Call the external function without passing course id.
        $reactforums = mod_reactforum_external::get_reactforums_by_courses();
        $reactforums = external_api::clean_returnvalue(mod_reactforum_external::get_reactforums_by_courses_returns(), $reactforums);
        $this->assertCount(2, $reactforums);
        foreach ($reactforums as $reactforum) {
            $this->assertEquals($expectedreactforums[$reactforum['id']], $reactforum);
        ...
        // Unenrol user from second course and alter expected reactforums.
        $enrol->unenrol_user($instance2, $user->id);
        unset($expectedreactforums[$reactforum2->id]);

        // Call the external function without passing course id.
        $reactforums = mod_reactforum_external::get_reactforums_by_courses();
        $reactforums = external_api::clean_returnvalue(mod_reactforum_external::get_reactforums_by_courses_returns(), $reactforums);
        $this->assertCount(1, $reactforums);
        $this->assertEquals($expectedreactforums[$reactforum1->id], $reactforums[0]);
        $this->assertTrue($reactforums[0]['cancreatediscussions']);

        // Change the type of the reactforum, the user shouldn't be able to add discussions.
        $DB->set_field('reactforum', 'type', 'news', array('id' => $reactforum1->id));
        $reactforums = mod_reactforum_external::get_reactforums_by_courses();
        $reactforums = external_api::clean_returnvalue(mod_reactforum_external::get_reactforums_by_courses_returns(), $reactforums);
        $this->assertFalse($reactforums[0]['cancreatediscussions']);

        // Call for the second course we unenrolled the user from.
        $reactforums = mod_reactforum_external::get_reactforums_by_courses(array($course2->id));
        $reactforums = external_api::clean_returnvalue(mod_reactforum_external::get_reactforums_by_courses_returns(), $reactforums);
        $this->assertCount(0, $reactforums);
    }

    /**
     * Test get reactforum posts
     */
    public function test_mod_reactforum_get_reactforum_discussion_posts() {
        global $CFG, $PAGE;

        $this->resetAfterTest(true);

        // Set the CFG variable to allow track reactforums.
        $CFG->reactforum_trackreadposts = true;

        // Create a user who can track reactforums.
        $record = new stdClass();
        $record->trackreactforums = true;
        ...
        // So the user automatically gets mod/reactforum:viewdiscussion on all reactforums of the course.
        ...
        $expectedposts['posts'][] = array(
            ...
            'message' => file_rewrite_pluginfile_urls($discussion1reply2->message, 'pluginfile.php',
                    $reactforum1context->id, 'mod_reactforum', 'post', $discussion1reply2->id),
        ...
        $expectedposts['posts'][] = array(
            ...
            'message' => file_rewrite_pluginfile_urls($discussion1reply1->message, 'pluginfile.php',
                    $reactforum1context->id, 'mod_reactforum', 'post', $discussion1reply1->id),
            'messageformat' => 1,   // This value is usually changed by external_format_text() function.
    ...
    /**
     * Test get reactforum posts (qanda reactforum)
     */
    public function test_mod_reactforum_get_reactforum_discussion_posts_qanda() {
        global $CFG, $DB;
        ...
        $DB->update_record('reactforum_posts', $discussion1reply2);
    ...
    /**
     * Test get reactforum discussions paginated
     */
    public function test_mod_reactforum_get_reactforum_discussions_paginated() {
        ...
        // First reactforum with tracking off.
        $record = new stdClass();
        $record->course = $course1->id;
        $record->trackingtype = REACTFORUM_TRACKING_OFF;
        $reactforum1 = self::getDataGenerator()->create_module('reactforum', $record);
        ...
        $discussion1reply3 = self::getDataGenerator()->get_plugin_generator('mod_reactforum')->create_post($record);
        ...
        // Assign capabilities to view discussions for reactforum 1.
        $cm = get_coursemodule_from_id('reactforum', $reactforum1->cmid, 0, false, MUST_EXIST);
        $context = context_module::instance($cm->id);
        $newrole = create_role('Role 2', 'role2', 'Role 2 description');
        $this->assignUserCapability('mod/reactforum:viewdiscussion', $context->id, $newrole);

        // Create what we expect to be returned when querying the reactforums.

        $post1 = $DB->get_record('reactforum_posts', array('id' => $discussion1->firstpost), '*', MUST_EXIST);
        ...
        $discussions = mod_reactforum_external::get_reactforum_discussions_paginated($reactforum1->id);
        $discussions = external_api::clean_returnvalue(mod_reactforum_external::get_reactforum_discussions_paginated_returns(), $discussions);
        ...
        $this->unassignUserCapability('mod/reactforum:viewdiscussion', $context->id, $newrole);
        try {
            mod_reactforum_external::get_reactforum_discussions_paginated($reactforum1->id);
    ...
    /**
     * Test get reactforum discussions paginated (qanda reactforums)
     */
    public function test_mod_reactforum_get_reactforum_discussions_paginated_qanda() {
        ...
        $discussionrecord->reactforum = $reactforum->id;
        $discussion = self::getDataGenerator()->get_plugin_generator('mod_reactforum')->create_discussion($discussionrecord);

        self::setAdminUser();
        $discussions = mod_reactforum_external::get_reactforum_discussions_paginated($reactforum->id);
        $discussions = external_api::clean_returnvalue(mod_reactforum_external::get_reactforum_discussions_paginated_returns(), $discussions);
    ...
    public function test_add_discussion_post() {
        ...
        $record->course = $course->id;
        $reactforum = self::getDataGenerator()->create_module('reactforum', $record);
        $cm = get_coursemodule_from_id('reactforum', $reactforum->cmid, 0, false, MUST_EXIST);
        $reactforumcontext = context_module::instance($reactforum->cmid);
        ...
        self::setUser($user);
        try {
            mod_reactforum_external::add_discussion_post($discussion->firstpost, 'some subject', 'some text here...');
            $this->fail('Exception expected due to being unenrolled from the course.');
        } catch (moodle_exception $e) {
            $this->assertEquals('requireloginerror', $e->errorcode);
        }
        ...
        $createdpost = mod_reactforum_external::add_discussion_post($discussion->firstpost, 'some subject', 'some text here...');
        $createdpost = external_api::clean_returnvalue(mod_reactforum_external::add_discussion_post_returns(), $createdpost);
        ...
        $dummytext = 'Here is an inline image: <img src="' . $CFG->wwwroot
                     ...
                     . '" alt="inlineimage">.';
        $createdpost = mod_reactforum_external::add_discussion_post($discussion->firstpost, 'new post inline attachment',
                                                               $dummytext, $options);
        $createdpost = external_api::clean_returnvalue(mod_reactforum_external::add_discussion_post_returns(), $createdpost);
        ...
        try {
            ...
            $this->assertEquals('nopostreactforum', $e->errorcode);
        }
    ...
    public function test_add_discussion() {
        ...
        try {
            mod_reactforum_external::add_discussion($reactforum->id, 'the subject', 'some text here...');
        ...
        self::setAdminUser();
        $createddiscussion = mod_reactforum_external::add_discussion($reactforum->id, 'the subject', 'some text here...');
        $createddiscussion = external_api::clean_returnvalue(mod_reactforum_external::add_discussion_returns(), $createddiscussion);
        ...
        $discussion2pinned = mod_reactforum_external::add_discussion($reactforum->id, 'the pinned subject', 'some 2 text here...', -1,
                                                                array('options' => array('name' => 'discussionpinned',
                                                                                         'value' => true)));
        $discussion3 = mod_reactforum_external::add_discussion($reactforum->id, 'the non pinnedsubject', 'some 3 text here...');
        $discussions = mod_reactforum_external::get_reactforum_discussions_paginated($reactforum->id);
        $discussions = external_api::clean_returnvalue(mod_reactforum_external::get_reactforum_discussions_paginated_returns(), $discussions);
        ...
        $options = array(array('name' => 'inlineattachmentsid', 'value' => $draftidinlineattach),
                         array('name' => 'attachmentsid', 'value' => $draftidattach));
        $createddiscussion = mod_reactforum_external::add_discussion($reactforum->id, 'the inline attachment subject',
                                                                $dummytext, -1, $options);
        $createddiscussion = external_api::clean_returnvalue(mod_reactforum_external::add_discussion_returns(), $createddiscussion);
    ...
    public function test_add_discussion_in_course_with_groups() {
        ...
        try {
            mod_reactforum_external::add_discussion($reactforum->id, 'the subject', 'some text here...', 0);
            $this->fail('Exception expected due to invalid group permissions.');
        } catch (moodle_exception $e) {
            $this->assertEquals('cannotcreatediscussion', $e->errorcode);
        }
        ...
        try {
            mod_reactforum_external::add_discussion($reactforum->id, 'the subject', 'some text here...', $group->id);
            $this->fail('Exception expected due to invalid group permissions.');
        } catch (moodle_exception $e) {
            $this->assertEquals('cannotcreatediscussion', $e->errorcode);
        }
        ...
        // Try to post in a group the user is not enrolled.
        try {
            mod_reactforum_external::add_discussion($reactforum->id, 'the subject', 'some text here...', $group->id + 1);
        ...
        $discussion = mod_reactforum_external::add_discussion($reactforum->id, 'the subject', 'some text here...', $group->id);
        $discussion = external_api::clean_returnvalue(mod_reactforum_external::add_discussion_returns(), $discussion);
        ...
        $discussion = mod_reactforum_external::add_discussion($reactforum->id, 'the subject', 'some text here...');
        $discussion = external_api::clean_returnvalue(mod_reactforum_external::add_discussion_returns(), $discussion);
    ...
    public function test_can_add_discussion() {
        ...
        // User with no permissions to add in a news reactforum.
        self::setUser($user);
        $this->getDataGenerator()->enrol_user($user->id, $course->id);
