...
class mod_reactforum_mail_testcase extends advanced_testcase {
    ...
    public function reactforum_post_email_templates_provider() {
                ...
                array(
                    ...
                    'contents' => array(
                        ...
                        'Attachment example.txt:\n' .
                            'http://www.example.com/moodle/pluginfile.php/\d*/mod_reactforum/attachment/\d*/example.txt\n',
        ...
        $newcase['expectations'][0]['contents'] = array(
            ...
            'Welcome to Moodle, *\n.*'
                .'http://www.example.com/moodle/pluginfile.php/\d+/mod_reactforum/post/\d+/'
        ...
        $newcase['expectations'][0]['contents'] = array(
            ...
            '<p>Welcome to Moodle, '
                .'<img src="http://www.example.com/moodle/pluginfile.php/\d+/mod_reactforum/post/\d+/'
                .'Screen%20Shot%202016-03-22%20at%205\.54\.36%20AM%20%281%29\.png"'
                .' alt="" width="200" height="393" class="img-responsive" />!</p>',
            '>Love Moodle', '>1\d1');
