YUI.add('moodle-mod_reactforum-subscriptiontoggle', function (Y, NAME) {
...
var LOGNAME = 'moodle-mod_reactforum-subscriptiontoggle';
...
Y.extend(SubscriptionToggle, Y.Base, {
    ...
    _toggleSubscription: function(e) {
        ...
        Y.io(this.get('uri'), {
            data: {
                ...
                reactforumid: clickedLink.getData('reactforumid'),
    ...
    ATTRS: {
         ...
         * @attribute uri
         * @type String
         * @default M.cfg.wwwroot + '/mod/reactforum/subscribe_ajax.php'
         */
        uri: {
            value: M.cfg.wwwroot + '/mod/reactforum/subscribe_ajax.php'
        }
    }
});

var NS = Y.namespace('M.mod_reactforum.subscriptiontoggle');
