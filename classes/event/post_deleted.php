...
/**
 * The mod_reactforum post deleted event.
 *
...
/**
 * The mod_reactforum post deleted event class.
 *
...
class post_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostdeleted', 'mod_reactforum');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'reactforum', 'delete post', $logurl, $this->objectid, $this->contextinstanceid);
    }
