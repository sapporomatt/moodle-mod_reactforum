...
class discussion_unpinned extends \core\event\base {
    ...
    public function get_description() {
        return "The user {$this->userid} has unpinned the discussion {$this->objectid} in the reactforum {$this->other['reactforumid']}";
    }
    ...
    public static function get_name() {
        return get_string('eventdiscussionunpinned', 'mod_reactforum');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'reactforum', 'unpin discussion', $logurl, $this->objectid, $this->contextinstanceid);
    }
