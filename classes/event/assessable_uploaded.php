...
/**
 * The mod_reactforum assessable uploaded event class.
 *
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has posted content in the reactforum post with id '$this->objectid' " .
            "in the discussion '{$this->other['discussionid']}' located in the reactforum with course module id " .
    ...
    protected function get_legacy_eventdata() {
        ...
        $eventdata->modulename   = 'reactforum';
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'mod_reactforum');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/reactforum/discuss.php', array('d' => $this->other['discussionid'], 'parent' => $this->objectid));
    }
