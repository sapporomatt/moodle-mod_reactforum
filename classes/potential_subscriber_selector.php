...
/**
 * A user selector control for potential subscribers to the selected reactforum
 * @package   mod_reactforum
 * @copyright  2017 (C) VERSION2, INC.
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_reactforum_potential_subscriber_selector extends mod_reactforum_subscriber_selector_base {
    /**
     * If set to true EVERYONE in this course is force subscribed to this reactforum
     * @var bool
     */
    ...
    public function find_users($search) {
        ...
        if ($this->forcesubscribed) {
            return array(get_string("existingsubscribers", 'reactforum') => $availableusers);
        } else {
            return array(get_string("potentialsubscribers", 'reactforum') => $availableusers);
        }
    }
    ...
    /**
     * Sets this reactforum as force subscribed or not
     */
