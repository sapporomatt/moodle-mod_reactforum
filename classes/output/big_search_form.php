...
class big_search_form implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $tagtypestoshow = \core_tag_area::get_showstandard('mod_reactforum', 'reactforum_posts');
        ...
        $data->tagsenabled = \core_tag_tag::is_enabled('mod_reactforum', 'reactforum_posts');
        $namefield = empty($CFG->keeptagnamecase) ? 'name' : 'rawname';
        $tags = $DB->get_records('tag',
            array('isstandard' => 1, 'tagcollid' => \core_tag_area::get_collection('mod_reactforum', 'reactforum_posts')),
