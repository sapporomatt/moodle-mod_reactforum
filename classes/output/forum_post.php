 ...
 */
class reactforum_post implements \renderable, \templatable {

    /**
     * The course that the reactforum post is in.
     *
     * @var object $course
     */
    ...
    /**
     * The course module for the reactforum.
     *
     * @var object $cm
     */
    protected $cm = null;
    ...
    /**
     * The reactforum that the post is in.
     *
     * @var object $reactforum
     */
    protected $reactforum = null;

    /**
     * The discussion that the reactforum post is in.
     *
    ...
    /**
     * The reactforum post being displayed.
     *
     * @var object $post
     */
    protected $post = null;
    ...
    /**
     * Whether to override reactforum display when displaying usernames.
    ...
    /**
     * Builds a renderable reactforum post
     *
     * @param object $course Course of the reactforum
     * @param object $cm Course Module of the reactforum
     * @param object $reactforum The reactforum of the post
     ...
     */
    public function __construct($course, $cm, $reactforum, $discussion, $post, $author, $recipient, $canreply) {
        $this->course = $course;
        $this->cm = $cm;
        $this->reactforum = $reactforum;
     ...
     *
     * @param \mod_reactforum_renderer $renderer The render to be used for formatting the message and attachments
     ...
     * @return stdClass Data ready for use in a mustache template
     */
    protected function export_for_template_text(\mod_reactforum_renderer $renderer) {
        return array(
            ...
            'reactforumname'                     => html_entity_decode($this->get_reactforumname()),
            ...
            'unsubscribereactforumlink'          => $this->get_unsubscribereactforumlink(),
            'parentpostlink'                => $this->get_parentpostlink(),

            'reactforumindexlink'                => $this->get_reactforumindexlink(),
            'reactforumviewlink'                 => $this->get_reactforumviewlink(),
     ...
     * @return stdClass Data ready for use in a mustache template
     */
    protected function export_for_template_html(\mod_reactforum_renderer $renderer) {
        return array(
            'id'                            => $this->post->id,
            'coursename'                    => $this->get_coursename(),
            'courselink'                    => $this->get_courselink(),
            'reactforumname'                     => $this->get_reactforumname(),
    ...
    /**
     * Get the link to the reactforum index for this course.
     *
     * @return string
     */
    public function get_reactforumindexlink() {
        $link = new \moodle_url(
            // Posts are viewed on the topic.
            '/mod/reactforum/index.php', array(
                'id'    => $this->course->id,
            )
        );
    ...
    /**
     * Get the link to the view page for this reactforum.
     *
     * @return string
     */
    public function get_reactforumviewlink() {
        $link = new \moodle_url(
            // Posts are viewed on the topic.
            '/mod/reactforum/view.php', array(
                'f' => $this->reactforum->id,
            )
        );
    ...
    protected function _get_discussionlink() {
        return new \moodle_url(
            // Posts are viewed on the topic.
            '/mod/reactforum/discuss.php', array(
                // Within a discussion.
    ...
    /**
     * Get the link to unsubscribe from the reactforum.
     *
     * @return string
     */
    public function get_unsubscribereactforumlink() {
        if (!\mod_reactforum\subscriptions::is_subscribable($this->reactforum)) {
            return null;
        }
        $link = new \moodle_url(
            '/mod/reactforum/subscribe.php', array(
                'id' => $this->reactforum->id,
            )
        );
    ...
    /**
     * ID number of the course that the reactforum is in.
     *
     * @return string
     */
    ...
    /**
     * The full name of the course that the reactforum is in.
     *
     * @return string
     */
    ...
    /**
     * The name of the course that the reactforum is in.
     *
     * @return string
     */
    ...
    /**
     * The name of the reactforum.
     *
     * @return string
     */
    public function get_reactforumname() {
        return format_string($this->reactforum->name, true);
    }
     ...
     * If the reactforum name matches the discussion name, the discussion name
     * is not typically displayed.
     *
     * @return boolean
     */
    public function get_showdiscussionname() {
        return ($this->reactforum->name !== $this->discussion->name);
    }
    ...
    public function get_postdate() {
        ...
        if (!empty($CFG->reactforum_enabletimedposts) && ($this->discussion->timestart > $postmodified)) {
    ...
    public function get_group_picture() {
        if (isset($this->userfrom->groups)) {
            $groups = $this->userfrom->groups[$this->reactforum->id];
        } else {
